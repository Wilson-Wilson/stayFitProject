...
public class DashBoardPanel extends JPanel {
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel = new JLabel("Calories Burned: " + TestAPI.getCalBurned());
        ...
        JLabel lblActiveMinutes = new JLabel("Active Minutes: " + TestAPI.getActiveMinutes());
        lblActiveMinutes.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
        lblActiveMinutes.setForeground(Color.WHITE);

        JLabel lblSedentayr = new JLabel("Sedentary Minutes: "  + TestAPI.getSedentaryMinutes());
        ...
        JLabel lblNewLabel_1 = new JLabel("Lifetime Steps: "   + TestAPI.getLifetimeSteps());
        lblNewLabel_1.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
        lblNewLabel_1.setForeground(new Color(255, 255, 255));

        JLabel lblLifetimeCalories = new JLabel("Lifetime Distance: "   + TestAPI.getLifetimeDistance());
        ...
        JLabel lblBestFloors = new JLabel("Best Floors: "   + TestAPI.getBestFloors());
        lblBestFloors.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
        lblBestFloors.setForeground(Color.WHITE);

        JLabel lblBestSteps = new JLabel("Best Steps: "   + TestAPI.getBestSteps());
