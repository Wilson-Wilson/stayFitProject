...
public class AccoDict {
  ...
  public AccoDict(){
	...
	theList[3] = new Accolade("15,000 Get a Bike","steps",15000, false);
	...
	theList[15] = new Accolade("50- Calves for Days","floors",50, false);
	theList[16] = new Accolade("60 Power Hour","activeMins",60, false);
	theList[17] = new Accolade("Double Time","activeMins",120, false);
	theList[18] = new Accolade("Need a Break","activeMins",200, false);
	theList[19] = new Accolade("Marathoner","activeMins",280, false);
  }
